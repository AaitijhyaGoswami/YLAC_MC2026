...
# 3. Add images to columns
    with cola:
      ...
      st.caption("Loose wires from underground power lines and street lamps, along with broken/removed sewage covers, make the pathways almost impossible to navigate for individuals with disabilities and can be fatal during rainy weathers for pedestrians")
