...
def app():
    ...
    with colx:
        st.image("cad_viewer\bazaar1.jpg", use_container_width=True)

    with coly:
        st.image("cad_viewer\bazaar2.jpg", use_container_width=True)

    with colz:
        st.image("cad_viewer\bazaar3.jpg", use_container_width=True)
